...
type
  TFListPerintahMuat = class(TForm)
    ...
    QListPerintahMuatdate_trans: TDateField;
    QListPerintahMuattype_do_name: TStringField;
    QListPerintahMuatstarting_loc_name: TStringField;
    QListPerintahMuatprovince_name: TStringField;
    QListPerintahMuatregency_name: TStringField;
