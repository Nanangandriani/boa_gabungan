...
begin
  ...
  begin
    ...
    sql.add(' Insert into "sale"."t_delivery_order" ("created_at", "created_by", '+
            ...
            ' "regency_name", "number_of_points", "percent_pph", "code_pph", "name_pph", '+
            ...
            ' '+QuotedStr(FloatToStr(edPersenPPH.Value))+', '+
            ' '+QuotedStr(edKodeAkunPPH.Text)+', '+
            ' '+QuotedStr(edNamaAkunPPH.Text)+', '+
            ' '+QuotedStr(FloatToStr(edPersenPPN.Value))+', '+
            ' '+QuotedStr(edKodeAkunPPN.Text)+', '+
            ' '+QuotedStr(edNamaAkunPPN.Text)+', '+
