  ...
  object Qdetailspb: TUniQuery
    ...
    SQL.Strings = (
      '-- SELECT a.*,b.item_name from purchase.t_spb_det a inner join'
        ...
        'a.warehouse,b.item_name  from purchase.t_spb_det a inner join'
      'warehouse.t_item_stock b on b.item_stock_code=a.item_stock_code')
    MasterSource = DsSPB
    MasterFields = 'spb_no'
    DetailFields = 'spb_no'
    Left = 432
