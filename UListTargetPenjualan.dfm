object FListTargetPenjualan: TFListTargetPenjualan
  Left = 0
  Top = 0
  Caption = 'List Target Penjualan'
  ClientHeight = 494
  ClientWidth = 741
  Color = clBtnFace
  ...
  object QTargetPenjualan: TUniQuery
    ...
    object QTargetPenjualanmonth: TSmallintField
      FieldName = 'month'
    end
    object QTargetPenjualanyear: TSmallintField
      FieldName = 'year'
    end
    object QTargetPenjualancreated_at: TDateTimeField
      FieldName = 'created_at'
    end
    object QTargetPenjualancreated_by: TStringField
      FieldName = 'created_by'
      Size = 50
    end
    object QTargetPenjualanupdated_at: TDateTimeField
      FieldName = 'updated_at'
    end
    object QTargetPenjualanupdated_by: TStringField
      FieldName = 'updated_by'
      Size = 50
    end
    object QTargetPenjualanid_customer_sales_target: TLargeintField
      AutoGenerateValue = arAutoInc
      FieldName = 'id_customer_sales_target'
    end
    object QTargetPenjualanstatus: TBooleanField
      FieldName = 'status'
    end
    object QTargetPenjualandeleted_at: TDateTimeField
  ...
  object DsTargetPenjualan: TDataSource
    DataSet = MemTargetPenjualan
    Left = 593
    Top = 64
  end
  object QtargetPenjualanDet: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      
        'SELECT b.item_name,a.item_code,a.qty,a.value,a.id_customer_sales' +
        '_target,b.group_id FROM t_customer_sales_target_det a '
      'LEFT JOIN t_item b on b.item_code=a.item_code'
      'WHERE a.status=true')
    MasterSource = DataSource1
    MasterFields = 'id_customer_sales_target;group_id'
    DetailFields = 'id_customer_sales_target;group_id'
    Left = 572
    Top = 24
    ParamData = <
      item
        DataType = ftLargeint
        Name = 'id_customer_sales_target'
        ParamType = ptInput
        Value = 8
      end
      item
    ...
    object QtargetPenjualanDetitem_name: TStringField
      FieldName = 'item_name'
      ReadOnly = True
      Size = 255
    end
    object QtargetPenjualanDetitem_code: TStringField
      FieldName = 'item_code'
      Size = 255
    end
    object QtargetPenjualanDetqty: TFloatField
      FieldName = 'qty'
    end
    object QtargetPenjualanDetvalue: TFloatField
      FieldName = 'value'
    end
    object QtargetPenjualanDetid_customer_sales_target: TLargeintField
      AutoGenerateValue = arAutoInc
      FieldName = 'id_customer_sales_target'
    end
    object QtargetPenjualanDetgroup_id: TIntegerField
      FieldName = 'group_id'
      ReadOnly = True
    end
  end
  object MemTargetPenjualan: TMemTableEh
    Params = <>
  ...
  object DataSetDriverEh1: TDataSetDriverEh
    ProviderDataSet = QTargetPenjualan
    Left = 704
    Top = 80
  end
  object DSTargetPenjualanDet: TDataSource
    DataSet = QtargetPenjualanDet
    Left = 529
    Top = 96
  end
