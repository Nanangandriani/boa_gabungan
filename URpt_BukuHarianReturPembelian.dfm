object FBuku_HarianReturPembelian: TFBuku_HarianReturPembelian
  Left = 0
  Top = 0
  Caption = 'FBuku_HarianReturPembelian'
  ClientHeight = 640
  ClientWidth = 1226
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'item_code'
        Footers = <>
        Title.Caption = 'Barang/Jasa|Kode'
        Width = 80
      end
      item
        CellButtons = <>
        ...
        FieldName = 'item_name'
        Footers = <>
        Title.Caption = 'Barang/Jasa|Nama Barang'
        Width = 150
      end
      item
        CellButtons = <>
      ...
      item
        ...
        FieldName = 'unit'
        Footers = <>
        Title.Caption = 'Barang/Jasa|Satuan'
      end
      item
        CellButtons = <>
        DynProps = <>
        ...
        FieldName = 'ak_htng'
        Footers = <>
        Title.Caption = 'Kredit|Hutang|No. Akun'
      end
      item
        CellButtons = <>
        DynProps = <>
        EditButtons = <>
        FieldName = 'ak_ht_name'
        Footers = <>
        Title.Caption = 'Kredit|Hutang|Nama Akun'
        Width = 150
      end
      item
        CellButtons = <>
      ...
      item
        ...
        FieldName = 'ak_pemb'
        Footers = <>
        Title.Caption = 'Debet|Pembelian|No. Akun'
      end
      item
        CellButtons = <>
        DynProps = <>
        EditButtons = <>
        FieldName = 'ak_pemb_name'
        Footers = <>
        Title.Caption = 'Debet|Pembelian|Nama Akun'
        Width = 150
      end
      item
        CellButtons = <>
  ...
  object Rpt: TfrxReport
    ...
    ReportOptions.CreateDate = 46058.614769432870000000
    ReportOptions.LastChange = 46058.614769432870000000
  ...
  object QRptBHP: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select a.return_no trans_no,a.return_date trans_date,a.faktur_no' +
        ',b.po_no,c.item_code,b.qty, c.unit,c.item_stock_code,c.item_name' +
        ',b.account_ppn,b.total_price subtotal, '
      
        'b.total_price +b.ppn grandtotal,d.code ak_htng,d.account_name ak' +
        '_ht_name,e.code ak_pemb,e.account_name ak_pemb_name, '
      
        'case when b.account_ppn <> '#39#39' then b.account_ppn else '#39#39' end ak_' +
        'ppn,           case when b.account_ppn <> '#39#39' then f.account_name' +
        ' else '#39#39' end ak_ppn_name,'
      ' c.group_name,h.supplier_name,a.supplier_code,b.ppn from '
      
        't_purchase_return a INNER JOIN  t_purchase_return_det b on a.ret' +
        'urn_no=b.return_no  '
        ...
        'INNER JOIN (select d1.code,d1.account_name,d2.account_code2 from' +
        ' t_ak_account d1 INNER JOIN t_ak_account_sub d2 on d1.code=d2.ac' +
        'count_code GROUP BY d1.code,d1.account_name,d2.account_code2) d ' +
        'on a.account_code=d.account_code2  '
      
        'INNER JOIN (select d1.code,d1.account_name,d2.account_code2 from' +
        ' t_ak_account d1 INNER JOIN t_ak_account_sub d2 on d1.code=d2.ac' +
        'count_code GROUP BY d1.code,d1.account_name,d2.account_code2) E ' +
        'on b.account_code=e.account_code2'
      
        'LEFT JOIN (select d1.code,d1.account_name,d2.account_code2 from ' +
        't_ak_account d1 INNER JOIN t_ak_account_sub d2 on d1.code=d2.acc' +
        'ount_code GROUP BY d1.code,d1.account_name,d2.account_code2) F o' +
        'n b.account_ppn=f.account_code2    '
      
        'INNER JOIN t_supplier h on a.supplier_code=h.supplier_code where' +
        ' return_date>='#39'2025-12-02'#39'  and return_date<='#39'2026-02-03'#39'  ORDER' +
        ' BY return_date,faktur_no ASC'
      '')
    Left = 179
    Top = 109
  end
  ...
  object Rpt_BHP: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'item_name=item_name'
      'account_ppn=account_ppn'
      'subtotal=subtotal'
      'grandtotal=grandtotal'
      'ak_htng=ak_htng'
      'ak_ht_name=ak_ht_name'
      'ak_pemb=ak_pemb'
      'ak_pemb_name=ak_pemb_name'
      'ak_ppn=ak_ppn'
      'ak_ppn_name=ak_ppn_name'
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarLargeButton2: TdxBarLargeButton
      Caption = 'Rician Penerimaan Barang'
      Category = 0
      Hint = 'Rician Penerimaan Barang'
      Visible = ivNever
      LargeGlyph.SourceDPI = 96
      LargeGlyph.Data = {
        89504E470D0A1A0A0000000D4948445200000020000000200806000000737A7A
