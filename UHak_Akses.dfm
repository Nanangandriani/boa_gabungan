object FHak_Akses: TFHak_Akses
  ...
  object QAkses: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select A.*,b.submenu2,c.Dept,d."position" from t_akses  a inner ' +
        'join t_submenu2 b on a.menu_code=b.kd_submenu'
      
        'inner join t_dept c on a.dept_code=c.dept_code INNER JOIN t_posi' +
        'tion d on a.position_code=d.position_code order by a.menu_code A' +
        'sc')
    Active = True
    Left = 440
    Top = 24
