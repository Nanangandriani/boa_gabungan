object Flap_Rencana_Pelunasan_Non_Hutang: TFlap_Rencana_Pelunasan_Non_Hutang
  Left = 0
  Top = 0
  Caption = 'Flap_Rencana_Pelunasan_Non_Hutang'
  ClientHeight = 442
  ClientWidth = 1108
  Color = clBtnFace
  ...
  object DBGridLapRencLunasNonHutang: TDBGridEh
    Left = 0
    Top = 127
    Width = 1108
    Height = 315
    Align = alClient
    DataSource = DS_renc_pelunasan_non_hutang
    DrawMemoText = True
    DynProps = <>
  ...
  object DataSetDriverEh1: TDataSetDriverEh
    ProviderDataSet = QLap_renc_pelunasan_non_hutang
    Left = 440
    Top = 264
  end
  object Mem_renc_pelunasan_non_hutang: TMemTableEh
    Params = <>
    DataDriver = DataSetDriverEh1
    Left = 440
    Top = 216
  end
  object QLap_renc_pelunasan_non_hutang: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      'select noinv, kepada,ket,'
      
        '(case when currency='#39'USD'#39' then jumlah*kurs else jumlah end) juml' +
        'ah from  '
      ''
      
        '(select voucher_no as noinv,to_ as kepada,trans_date,1 as urutan' +
        ',remark as ket,currency,kurs,sum(paid_amount)as jumlah from '
      
        '(SELECT  a.voucher_no,a.to_,a.trans_date,a.periode1,a.periode2,a' +
        '.remark,a.currency,a.kurs,a.plan_to,b.code_account,b."position",' +
        'b.paid_amount from t_cash_bank_expenditure_submission a INNER JO' +
        'IN t_cash_bank_expenditure_submission_det b on a.voucher_no=b.no' +
        '_voucher)a'
      
        'where periode1='#39'2025-03-11'#39' and periode2='#39'2025-03-11'#39' and plan_t' +
        'o='#39'1'#39' and "position" ='#39'D'#39' and code_account<>'#39'2101.01'#39' '
      
        'and code_account not in(SELECT account_code FROM t_expenses_paya' +
        'ble_account) and code_account not in(SELECT account_code FROM t_' +
        'asset_payable_account) group by voucher_no,to_,trans_date,remark' +
        ',currency,kurs  '
      ''
      'UNION ALL'
      '  '
      
        'select a.voucher_no as noinv,a.to_ as kepada,a.trans_date,2 as u' +
        'rutan,a.remark as ket,currency,kurs,-(sum(a.paid_amount))as juml' +
        'ah from '
      
        '(SELECT a.voucher_no,a.to_,a.remark as kepada,a.trans_date,a.rem' +
        'ark,a.currency,a.kurs,a.periode1,a.periode2,plan_to,b."position"' +
        ',b.code_account,b.paid_amount from t_cash_bank_expenditure_submi' +
        'ssion a INNER JOIN t_cash_bank_expenditure_submission_det b on a' +
        '.voucher_no=b.no_voucher)a  '
      'where voucher_no IN '
      '(select voucher_no from '
      
        '(SELECT a.voucher_no,a.periode1,a.periode2,a.trans_date,to_,plan' +
        '_to,remark,currency,kurs,"position",code_account from t_cash_ban' +
        'k_expenditure_submission a INNER JOIN t_cash_bank_expenditure_su' +
        'bmission_det b on a.voucher_no=b.no_voucher)x '
        ...
        'and code_account not in(SELECT account_code FROM t_asset_payable' +
        '_account)'
      
        'and periode1='#39'2025-03-11'#39' and periode2='#39'2025-03-11'#39' and plan_to=' +
        #39'1'#39' and "position"='#39'K'#39' and code_account<>'#39'1101.01'#39')  '
      
        'group by voucher_no,to_,trans_date,remark,currency,kurs,periode1' +
        ',periode2,plan_to,"position",code_account)y'
      ''
      'WHERE y.noinv in'
      '(select distinct z.voucher_no from '
      
        '(SELECT a.voucher_no from t_cash_bank_expenditure_submission a I' +
        'NNER JOIN t_cash_bank_expenditure_submission_det b on a.voucher_' +
        'no=b.no_voucher)z '
      
        'EXCEPT select DISTINCT voucher_no from t_cash_bank_expenditure_s' +
        'ubmission_payable) order by noinv;')
    Left = 376
    Top = 216
  end
  ...
  object frxDBDataset1: TfrxDBDataset
    UserName = 'frxDBDataset_rencana_pelunasan_non_hutang'
    CloseDataSource = False
    FieldAliases.Strings = (
      'noinv=noinv'
      'kepada=kepada'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 45871.449136967600000000
    ...
    Datasets = <
      ...
      item
        ...
        DataSetName = 'frxDBDataset_rencana_pelunasan_non_hutang'
      end
      item
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo26: TfrxMemoView
          AllowVectorExport = True
          Left = 262.299212598425000000
          Top = 117.102350000000000000
          Width = 390.425196850394000000
          Height = 32.456692910000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo11: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_non_hutang."kepada"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo27: TfrxMemoView
          AllowVectorExport = True
          Left = 652.968503940000000000
          Top = -1.000000000000000000
          Width = 104.314960630000000000
          Height = 30.346456690000000000
          StretchMode = smMaxHeight
          DataField = 'jumlah'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset_rencana_pelunasan_non_hutang'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_non_hutang."jumlah"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo28: TfrxMemoView
          AllowVectorExport = True
          Left = 262.165354330000000000
          Top = -1.000000000000000000
          Width = 390.559055120000000000
          Height = 30.346456690000000000
          StretchMode = smMaxHeight
          DataField = 'ket'
          DataSet = frxDBDataset1
          ...
          Frame.Typ = [ftRight, ftBottom]
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_non_hutang."ket"]')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo62: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<frxDBDataset_rencana_pelunasan_non_hutang."jumlah">,Master' +
              'Data1,1)]')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object DS_renc_pelunasan_non_hutang: TDataSource
    DataSet = Mem_renc_pelunasan_non_hutang
    Left = 376
    Top = 264
  end
end
