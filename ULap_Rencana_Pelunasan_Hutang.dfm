object Flap_Rencana_Pelunasan_Hutang: TFlap_Rencana_Pelunasan_Hutang
  Left = 0
  Top = 0
  Caption = 'Laporan Rencana Pelunasan Hutang'
  ClientHeight = 442
  ClientWidth = 1146
  Color = clBtnFace
  ...
  OnShow = FormShow
  TextHeight = 15
  object DBGridLapRencLunasHutang: TDBGridEh
    Left = 0
    Top = 127
    Width = 1146
    Height = 315
  ...
  object DS_renc_pelunasan_hutang: TDataSource
    DataSet = Mem_renc_pelunasan_hutang
    Left = 376
    Top = 264
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 46079.391636828700000000
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        FillGap.Right = 0
        Frame.Typ = []
        Height = 151.582677170000000000
        Top = 18.897650000000000000
        Width = 755.906000000000000000
        object Memo_jenis_hutang: TfrxMemoView
        ...
        object Memoperiode2: TfrxMemoView
          AllowVectorExport = True
          Left = 2.000000000000000000
          Top = 90.708661420000000000
          Width = 510.488250000000000000
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo11: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_hutang."principle_name"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo12: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_hutang."sj_no"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo13: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_hutang."tanggal"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo28: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_hutang."ket"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo30: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset_rencana_pelunasan_hutang."nofakturpajak"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object SysMemo1: TfrxSysMemoView
          ...
          Top = 6.448670000000000000
          Width = 32.826840000000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        FillGap.Right = 0
        Frame.Typ = []
        Height = 213.078540000000000000
        Top = 396.850650000000000000
        Width = 755.906000000000000000
        object Memo36: TfrxMemoView
          AllowVectorExport = True
          Left = 392.575140000000000000
          Top = 46.763760000000000000
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 755.906000000000000000
        Condition = 'frxDBDataset_rencana_pelunasan_hutang."supplier_code"'
  ...
  object QCetak: TUniQuery
    ...
    SQL.Strings = (
      ...
      'FROM '
        ...
        'upplier_name as principle_name,c.trans_date as tanggal,c.faktur_' +
        'no as nofakturpajak,c.sj_no,c.faktur_date+due_date as tgltempo,a' +
        '.amount as jumlah,1 as urutan,bb.nm as ket FROM '
      '(SELECT * FROM t_paid_debt_det '
      'WHERE factory_code='#39'HLJ'#39' '
      'and supplier_code='#39'SP0093'#39' '
      'and periode1='#39'2025-04-11'#39' and periode2='#39'2025-04-11'#39' '
      'and plan_to='#39'1'#39' '
      ...
      'LEFT JOIN  '
      '(select inv_no,string_agg(nm,'#39', '#39') nm from '
      
        '(SELECT distinct z.id,inv_no,string_agg (concat(item_name,'#39' '#39',RE' +
        'PLACE(TO_CHAR(qty,'#39'FM999G999G990.00'#39'), '#39','#39', '#39'.'#39'),'#39' '#39',unit),'#39', '#39')' +
        'nm from '
      
        '(SELECT distinct m.id,k.inv_no,n.item_name,sum(m.qty) qty,n.unit' +
        ' from t_paid_debt_det k '
      ...
      'INNER JOIN t_purchase_invoice_det m ON l.trans_no=m.trans_no '
        ...
        ' where k.factory_code='#39'HLJ'#39'  '
      'and k.periode1='#39'2025-04-11'#39' and k.periode2='#39'2025-04-11'#39'  '
      'and k.plan_to='#39'1'#39' '
      
        'and  l.account_code in (SELECT account_code FROM t_expenses_paya' +
        'ble_account)'
      
        'GROUP BY m.id,k.inv_no,n.item_name,n.unit ) z  group by z.inv_no' +
  ...
  object QLap_renc_pelunasan_hutang: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
  ...
  object Mem_renc_pelunasan_hutang: TMemTableEh
    Params = <>
  ...
  object DataSetDriverEh1: TDataSetDriverEh
    ProviderDataSet = QLap_renc_pelunasan_hutang
    Left = 440
    Top = 264
  end
  ...
  object dxBarManager1: TdxBarManager
    ...
    object code_supp: TcxBarEditItem
      Caption = 'Supplier          : '
      Category = 0
      Hint = 'Supplier          : '
      Visible = ivAlways
    ...
    object Cb_semua: TcxBarEditItem
      Caption = 'Semua'
      Category = 0
      Hint = 'Semua'
      Visible = ivAlways
