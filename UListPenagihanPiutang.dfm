object FListPenagihanPiutang: TFListPenagihanPiutang
  ...
  object QListPenagihanPiutang: TUniQuery
    ...
    SQL.Strings = (
        ...
        'SELECT "date_dpp", "date_print", "code_collector" , "name_collec' +
        'tor",  b."wilayah", count(a.no_invoice) as tot_lmbr_invoice, SUM' +
        '(a.paid_amount) jum_tagihan,b.code_karesidenan,b.name_karesidena' +
        'n ,b.code_regency,b.name_regency  from "public"."t_dpp" a  LEFT ' +
        'JOIN (SELECT tc.code AS kd_master, tc.name AS nm_master,   conca' +
        't('#39'Kares. '#39', tc.name_kares, '#39', Kabupaten. '#39', tc.name_regency)  A' +
        'S wilayah ,tc.code_regency,d.name name_regency,d.code_karesidena' +
        'n, e.name name_karesidenan  from "public"."t_collector" tc   LEF' +
        'T JOIN t_region_regency d ON d.code=tc.code_regency  LEFT JOIN t' +
        '_region_karesidenan e ON e.code=d.code_karesidenan   ) b ON a."c' +
        'ode_collector"=b."kd_master"  where a.deleted_at is null  GROUP ' +
        'BY "date_dpp", "date_print", "code_collector", "name_collector",' +
        ' b."wilayah",b.code_regency,b.name_regency,b.code_karesidenan,b.' +
        'name_karesidenan  ORDER BY "date_dpp", "date_print", "code_colle' +
        'ctor", "name_collector", b."wilayah" Desc')
    Left = 428
    Top = 56
    ...
    object QListPenagihanPiutangcode_karesidenan: TStringField
      FieldName = 'code_karesidenan'
      ReadOnly = True
      Size = 255
    end
    object QListPenagihanPiutangname_karesidenan: TStringField
      FieldName = 'name_karesidenan'
      ReadOnly = True
      Size = 255
    end
    ...
    object QListPenagihanPiutangname_regency: TStringField
