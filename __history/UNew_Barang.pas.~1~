...
uses UKategori_Material, UDataModule, UAkun_Perkiraan_TerimaMat, UListBarang;



procedure TFInput_Material.Load;
begin
  Edjenis.Clear;
  with dm.Qtemp do
  begin
...
procedure TFInput_Material.EdCategorySelect(Sender: TObject);
var no_urut:string;
begin
    with dm.Qtemp3 do
    begin
...
procedure TFInput_Material.EdjenisSelect(Sender: TObject);
begin
    EdCategory.Clear;
...
procedure TFInput_Material.FormShow(Sender: TObject);
begin
    EdCategory.SetFocus;
