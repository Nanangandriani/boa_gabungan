...
begin
    ...
    begin
      FKategori_material.Edkd_akun.Text:=query1.fieldbyname('kode').AsString;
      FKategori_material.EdNm_akun.Text:=query1.fieldbyname('nama_perkiraan').AsString;
      query1.Close;
      fdafperkiraan.Close;
    end
    //else
