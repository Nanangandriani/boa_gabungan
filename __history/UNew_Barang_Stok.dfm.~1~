object FNew_Barang_stok: TFNew_Barang_stok
  Left = 0
  Top = 0
  Caption = 'PT HHA'
  ClientHeight = 271
  ...
  object EdNm_Material1: TRzComboBox
    ...
    TabOrder = 6
    Visible = False
    OnChange = EdNm_Material1Change
    OnSelect = EdNm_Material1Select
  end
  ...
  object EdNm_Material: TRzButtonEdit
    ...
    AltBtnNumGlyphs = 1
    ButtonNumGlyphs = 1
    OnButtonClick = EdNm_MaterialButtonClick
  end
end
