...
begin
    ...
    begin
      ...
      SQL.Text:='select max(Right(kd_submenu,4))as no from t_submenu2 ';
      ExecSQL;
    end;
...
begin
    ...
    begin
      close;
      sql.Clear;
      sql.Text:=' select a.*,b.menu,c.Dept from t_akses  a inner join t_menu b on '+
                ' a.id_menu=b.id_menu inner join t_dept c on a.iddept=c.dept_code '+
