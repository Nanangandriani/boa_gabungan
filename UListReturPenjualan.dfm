object FListReturPenjualan: TFListReturPenjualan
  ...
  object QCetak: TUniQuery
    ...
    SQL.Strings = (
      ...
      #9') A'
        ...
        'ustomer_code'
      'WHERE'
      #9'a.trans_no = '#39'RJ-0002/21/IX/24'#39' '
      'ORDER BY'
      #9'a.trans_no,'
      #9'code_item DESC')
    Left = 12
    ...
    object QCetakamount_sale: TFloatField
      FieldName = 'amount_sale'
      ReadOnly = True
    end
    ...
    object QCetakunit_price_sale: TFloatField
      FieldName = 'unit_price_sale'
      ReadOnly = True
    end
    ...
    object QCetakno_trans_sale: TStringField
      FieldName = 'no_trans_sale'
      ReadOnly = True
      Size = 100
    end
  ...
  object frxDBDRetPenjualan: TfrxDBDataset
    UserName = 'frxDBDRetPenjualan'
  ...
  object Report: TfrxReport
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object frxDBDPenjualanname_cust: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 10.118120000000000000
          Top = 162.196970000000000000
          Width = 287.244280000000000000
          Height = 21.123376670000000000
          DataSet = frxDBDRetPenjualan
          DataSetName = 'frxDBDRetPenjualan'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDRetPenjualan."name_cust"]')
          ParentFont = False
        end
        object frxDBDPenjualanaddress: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 10.118120000000000000
          Top = 184.653680000000000000
          Width = 341.244280000000000000
          Height = 66.241496670000000000
          DataSet = frxDBDRetPenjualan
          DataSetName = 'frxDBDRetPenjualan'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object frxDBDPenjualanno_trans: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDRetPenjualan."trans_no"]')
          ParentFont = False
        end
        object telp: TfrxMemoView
          AllowVectorExport = True
          Left = 10.118120000000000000
        ...
        object Memo31: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDRetPenjualan."no_trans_sale"]')
          ParentFont = False
        end
      end
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo20: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'PPN [frxDBDRetPenjualan."ppn_percent"] %')
          ParentFont = False
        end
  ...
  object Qdetail: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      'select * from t_sales_returns_det')
    MasterSource = DsReturJual
