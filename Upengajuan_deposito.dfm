object Fpengajuan_deposito: TFpengajuan_deposito
  Left = 0
  Top = 0
  Caption = 'Fpengajuan_deposito'
  ClientHeight = 442
  ClientWidth = 918
  Color = clBtnFace
  ...
  object DBGrid_Ajuan_Deposito: TDBGridEh
    Left = 0
    Top = 225
    Width = 918
    Height = 217
    Align = alClient
    DataSource = DS_Dep_Ajuan
    DynProps = <>
  ...
  object Qdeposito_ajuan: TUniQuery
  ...
  object DS_Dep_Ajuan: TDataSource
    DataSet = Qdeposito_ajuan
    Left = 800
    Top = 159
  end
end
