object FHasil_Perc_Barang: TFHasil_Perc_Barang
  Left = 0
  Top = 0
  Caption = 'Form Hasil Percampuran Barang'
  ClientHeight = 468
  ClientWidth = 854
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    DataGrouping.GroupLevels = <
      ...
      item
        ColumnName = 'Column_7_trans_month'
      end
      item
        ColumnName = 'Column_9_trans_day'
      end>
    DataSource = DsHasil
    DrawMemoText = True
    DynProps = <>
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'mixing_no'
        Footers = <>
        Title.Caption = 'No. Permintaan Material'
        Width = 144
      end
      item
        CellButtons = <>
  ...
  object Qhasil: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      
        'select (case WHEN a.status=0 THEN '#39'In-Proses'#39' else '#39'Selesai'#39' END' +
        ') AS statustr,A.*,B.item_name from warehouse.t_item_mixing_resul' +
        't A inner join warehouse.t_item_stock B'
      'on A.item_stock_code=B.item_stock_code order by a.result_no desc')
    Left = 520
    Top = 32
  end
