object FMaster_Akun: TFMaster_Akun
  Left = 0
  Top = 0
  ...
  object QMaster_akun: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      
        'select a.*,b.account_name from t_ak_account_master a inner join ' +
        't_ak_account b on a.account_code=b.code order by master_id')
    Left = 304
    Top = 8
  end
  object Ds_Master_Akun: TDataSource
    DataSet = QMaster_akun
    Left = 304
    Top = 64
  end
end
