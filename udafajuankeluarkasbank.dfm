object Fdafajuankeluarkasbank: TFdafajuankeluarkasbank
  ...
  object Qdaf_PengajuanKasBank: TUniQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        't",a."bank_name_account",a."additional_code",a."id" ,'
      'a.cheque_no,a.cheque_date,a.cheque_due_date,'
      
        'b."code_module",b."name_module",b."name_trans",c."code",c."name"' +
        ',d."currency_name",e."source_name" '
    ...
    object Qdaf_PengajuanKasBankcheque_no: TStringField
      FieldName = 'cheque_no'
      Size = 50
    end
    object Qdaf_PengajuanKasBankcheque_date: TDateField
      FieldName = 'cheque_date'
    end
    object Qdaf_PengajuanKasBankcheque_due_date: TDateField
      FieldName = 'cheque_due_date'
    end
  end
  ...
  object QBukti_Ajuan_Keluar: TUniQuery
    ...
    SQL.Strings = (
      ...
      #9'SELECT'
        ...
        #9'    voucher_no,subvoucher,remark as ket,entry_date,trans_date,p' +
        'eriode1,periode2,amount,account_code,account_name,dk,debit,kredi' +
        't,'#9'header_code,ref_no,posting,customer_code,supplier_code,cash_t' +
        'ype,job_no,company_code,tp_code,trans_year,trans_month,trans_day' +
        ','#9'order_no,giro_no,bank_giro_name,giro_due_date,customer_name,su' +
        'pplier_name,to_,deposit,deposit_date,tgup,voucher_code,to_getout' +
        ','#9'status,approve_status,approval_date,approval,app_stat,currency' +
        ',kurs,plan_to,bon_no,bank_norek,bank_name,amount_origin,'#9'debit_a' +
        'mount_origin,credit_amount_origin,created_at,created_by,updated_' +
        'at,updated_by,deleted_at,deleted_by,trans_type_code,'#9'trans_type_' +
        'name,bank_number_account,bank_name_account,additional_code,id,ch' +
        'eque_no,cheque_date,cheque_due_date'
      #9
      #9'FROM'
      #9#9'"public"."t_cash_bank_expenditure_submission" A '
      #9'WHERE'
      #9#9'"voucher_no" = '#39#39' '
      #9#9'AND deleted_at IS NULL '
      #9')'
      #9'A LEFT JOIN ('
      #9'SELECT'
      
        #9'    no_voucher,code_account,name_account,"position",paid_amount' +
        ',description,code_account_header,amount_rate_results,'#9'module_id,' +
        'trans_date'
      #9'FROM'
      #9#9'"public"."t_cash_bank_expenditure_submission_det" aa'
      
        #9'LEFT JOIN t_ak_account bb ON aa."code_account_header" = bb.code' +
        ' '
      #9') b ON A."voucher_no" = b."no_voucher" '
      'WHERE'
      #9'A."voucher_no" ='#39#39' '
      #9'AND "position" = '#39'D'#39')x'
      'LEFT JOIN'
      '(SELECT no_voucher,code_account,"position" FROM'
      
        '(SELECT no_voucher,code_account,"position" FROM "public"."t_cash' +
        '_bank_expenditure_submission_det" x LEFT JOIN t_ak_account y ON ' +
  ...
  object frxDBDBukti_Ajuan_Keluar: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'order_no=order_no'
      'giro_no=giro_no'
      'bank_giro_name=bank_giro_name'
      'giro_due_date=giro_due_date'
      ...
      'debit_amount_origin=debit_amount_origin'
      'credit_amount_origin=credit_amount_origin'
  ...
  object Report: TfrxReport
    ...
    ReportOptions.LastChange = 46084.482640659700000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'var'
      '  vTotalAngka: Double;'
      '  vTotalRecord: Integer;'
      'procedure LineOnBeforePrint(Sender: TfrxComponent);'
      'begin'
      
        '  //vTotalAngka:=vTotalAngka+<frxDBDBuktiAjuan_Faktur."paid_amou' +
        'nt">;'
      '  //vTotalAngka:=vTotalAngka+0;'
      ' // SysMemo1.Text:= FormatFloat('#39'#,##0.00'#39', vTotalAngka);'
      ''
      'if <Line#> <> StrToInt(Trim(tot_rec.Text)) then'
      'begin'
      ...
      'else'
      'begin'
      '  //terbilang.Visible := True;'
      '  //SysMemo1.Visible := True;'
      
        '  //SysMemo1.Text := FormatFloat('#39'#,##0.00'#39', <SUM(<frxDBDBuktiKe' +
        'luar_Faktur."paid_amount">, MasterData1)>);'
      ''
      'end;'
      'end;'
      ''
      ...
      'begin'
        ...
        '  vTotalAngka:=vTotalAngka+<frxDBDBuktiAjuan_Faktur."paid_amount' +
        '">;'
      '  //vTotalAngka:=vTotalAngka+0;'
      '  SysMemo1.Text:= FormatFloat('#39'#,##0.00'#39', vTotalAngka);'
      'end;'
    ...
    Datasets = <
      ...
      item
        DataSet = frxDBDBukti_Ajuan_Keluar
        DataSetName = 'frxDBDBuktiAjuan'
      end
      item
        DataSet = frxDBDBuktiAjuan_Faktur
        DataSetName = 'frxDBDBuktiAjuan_Faktur'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object terbilang: TfrxMemoView
          ...
          Left = 230.338590000000000000
          Top = 47.000000000000000000
          Width = 520.016080000000000000
        ...
        object Memo30: TfrxMemoView
          AllowVectorExport = True
          Left = 78.440940000000000000
          Top = 47.244094490000000000
          Width = 145.944960000000000000
          Height = 18.897637800000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDBuktiAjuan."bank_name"] [frxDBDBuktiAjuan."cheque_no"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo31: TfrxMemoView
          AllowVectorExport = True
          Left = 117.102350000000000000
          Top = 64.251968500000000000
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBDCetakSJname_item: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDBuktiAjuan_Faktur."description"]')
          ParentFont = False
        end
        object frxDBDQBukti_Terimapaid_amount: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDBuktiAjuan_Faktur."paid_amount"]')
          ParentFont = False
        end
        object frxDBDBuktiAjuan_Fakturaccount_acc: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 173.858380000000000000
          Width = 90.708720000000000000
          Height = 18.897650000000000000
          DataField = 'account_acc'
          DataSet = frxDBDBuktiAjuan_Faktur
          DataSetName = 'frxDBDBuktiAjuan_Faktur'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDBuktiAjuan_Faktur."account_acc"]')
          ParentFont = False
        end
        object frxDBDBuktiAjuan_Fakturaccount_name: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDBuktiAjuan_Faktur."account_name"]')
          ParentFont = False
        end
        object Line: TfrxMemoView
          ...
          Height = 18.897650000000000000
          Visible = False
          OnAfterPrint = 'LineOnAfterPrint'
          OnBeforePrint = 'LineOnBeforePrint'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
          Font.Name = 'Arial'
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo7: TfrxMemoView
          AllowVectorExport = True
          Left = 509.976377950000000000
          Top = 93.590538980000000000
        ...
        object Memo19: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDBuktiAjuan."trans_date"]')
          ParentFont = False
        end
        object Line9: TfrxLineView
          AllowVectorExport = True
          Left = 589.606680000000000000
          Top = 128.559030710000000000
        ...
        object Line11: TfrxLineView
          ...
          Height = 185.196847950000000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
        end
        object tot_rec: TfrxMemoView
          AllowVectorExport = True
  ...
  object DSTP_Ajuan: TDataSource
    DataSet = QTP_Ajuan
    Left = 848
    Top = 296
  end
  object QBukti_Ajuan_Keluar_Faktur: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
  ...
  object frxDBDBuktiAjuan_Faktur: TfrxDBDataset
    UserName = 'frxDBDBuktiAjuan_Faktur'
    CloseDataSource = False
    FieldAliases.Strings = (
      'voucher_no=voucher_no'
