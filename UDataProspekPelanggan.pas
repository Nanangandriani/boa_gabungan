...
begin
  ...
  begin
    ...
    begin
      //Edkode.Text:=Dm.Qtemp.FieldByName('outlet_code').AsString;
      //Edautocode.Text:=Dm.Qtemp.FieldByName('outlet_code').AsString;
      ...
      Ednomorva.Text:='0';
      Edkodewilayah.Text:=Dm.Qtemp.FieldByName('distribution_code').AsString;
      Ednamawilayah.Text:=Dm.Qtemp.FieldByName('distribution_code').AsString;
      ...
      vid_prospek:=MemMasterData['idprospek'];
        if Dm.Qtemp.FieldByName('no_npwp').AsString='0' then
        begin
          cbpkp.Checked:=false;
        end;
        if Dm.Qtemp.FieldByName('no_npwp').AsString<>'0' then
 ...
 ShowMessage('A non-Indy related exception has been raised!');
  ...
  begin
    ...
    sql.Text:=' insert into t_customer_prospect_tmp(code_details_address,created_by,outlet_code,idprospek,'+
              ...
              ' latitude,no_ktp,group_outlet,no_hp) values ('+
