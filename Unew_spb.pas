...
begin
      ...
      begin
          ...
          begin
            close;
            sql.Clear;
            sql.Text:='Insert Into purchase.t_spb_det(spb_no,po_no,item_stock_code,qty,unit,warehouse)'+
    ...
    begin
      ...
      begin
        ...
        sql.Text:='insert into purchase.t_spb(supplier_code,spb_no,spb_date, pic,vehicle_no,driver,approval_status,'+
                  ...
                  ParamByName('parjamserah').Value:=EdJam_Serah.Text;
                  ParamByName('parjamkembali').Value:=Edjam_kembali.Text;
