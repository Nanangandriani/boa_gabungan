...
//    ShowMessage(MemDetail['BERAT_KOSONG']);
    ...
    terbilang:= ConvKeHuruf(FloatToStr(MemDetail['JUMLAH']));
    with dm.Qtemp do
    begin
      close;
      sql.clear;
...
begin
  ...
  begin
    ...
    begin
      ...
      FNew_Penjualan.MemDetail['BERAT_ISI']:=Dm.Qtemp.fieldbyname('gross_weight').value else
      FNew_Penjualan.MemDetail['BERAT_ISI']:=0;
