object Frekap_ppn_masukan: TFrekap_ppn_masukan
  Left = 0
  Top = 0
  Caption = 'Frekap_ppn_masukan'
  ClientHeight = 442
  ClientWidth = 788
  Color = clBtnFace
  ...
  object DBGridRekap_ppn: TDBGridEh
    Left = 0
    Top = 127
    Width = 788
    Height = 274
  ...
  object QRekap_ppn_masukan: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      
        'SELECT DISTINCT a.voucher_no,a.trans_date,'#39#39' nofaktur,a.remark,a' +
        '.to_,0 dpp,a.paid_amount,a.code_account,a."position" from (SELEC' +
        'T a.voucher_no,b.trans_date,'#39#39' nofaktur,a.remark,a.to_,0 dpp,b.p' +
        'aid_amount,b.code_account,b."position" FROM t_cash_bank_expendit' +
        'ure a INNER JOIN t_cash_bank_expenditure_det b on a.voucher_no=b' +
        '.no_voucher) a where code_account='#39'1131.06'#39' and "position"='#39'D'#39)
    Left = 368
    Top = 200
  end
  object DSppn_masukan: TDataSource
    AutoEdit = False
    DataSet = Mem_ppn_masukan
    Left = 368
    Top = 264
  end
  object Mem_ppn_masukan: TMemTableEh
    Active = True
    Params = <>
  ...
  object DataSetDriverEh1: TDataSetDriverEh
    ProviderDataSet = QRekap_ppn_masukan
    Left = 472
    Top = 264
  end
  ...
  object frxrekapppnmasukan: TfrxReport
    Version = '2022.1.3'
    ...
    ReportOptions.LastChange = 44649.476603912000000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo25: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[sum(<frxDBDataset1."dpp">)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Line19: TfrxLineView
          AllowVectorExport = True
          Left = 564.842519690000000000
          Height = 26.456692910000000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Visible = False
        Width = 740.409927000000000000
        Condition = '<frxDBDataset1."voucher_no">'
