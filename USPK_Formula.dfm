object FSPK_Formula: TFSPK_Formula
  Left = 0
  Top = 0
  Caption = 'Form SPK Formula Test'
  ClientHeight = 604
  ClientWidth = 1236
  Color = clBtnFace
  ...
  object Dbgridspk_for: TDBGridEh
    ...
    DataGrouping.GroupLevels = <
      ...
      item
        ColumnName = 'Column_13_trial_date'
      end>
    DataSource = DsSpkFormula
    DynProps = <>
    ...
    OnCellClick = Dbgridspk_forCellClick
    Columns = <
      item
        CellButtons = <>
        DynProps = <>
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarManager1Bar3: TdxBar
      ...
      ItemLinks = <
        item
          Visible = True
          ItemName = 'BPrintBonTepung'
        end
        item
          Visible = True
          ItemName = 'BPrintBonKimia'
        end>
      OneOnRow = False
      Row = 0
      UseOwnFont = False
    ...
    object dxBarManager1Bar4: TdxBar
      ...
      ItemLinks = <
        item
          Visible = True
          ItemName = 'BPrintTimbangTepung'
        end
        item
          Visible = True
          ItemName = 'BPrintTimbangKimia'
        end>
      OneOnRow = False
      Row = 0
      UseOwnFont = False
    ...
    object BPrintBonTepung: TdxBarButton
      ...
      OnClick = BPrintBonTepungClick
    end
    object BPrintBonKimia: TdxBarButton
      Caption = 'Print BON Kimia     '
      Category = 0
      Hint = 'Print BON Kimia     '
      Visible = ivAlways
      Glyph.SourceDPI = 96
      Glyph.Data = {
        424D360900000000000036000000280000001800000018000000010020000000
    ...
    object BPrintTimbangTepung: TdxBarButton
      ...
      Glyph.Data = {
        ...
        FCFFFCFCFCFFFCFCFCFFFCFCFCFFFCFCFCFFFDFDFDFFFDFDFDFFFDFDFDFFFDFD
        FDFFFDFDFDFFFDFDFDFFFCFCFCFFFCFCFCFFFDFDFDFF}
      OnClick = BPrintTimbangTepungClick
    end
    ...
    object BPrintTimbangKimia: TdxBarButton
      Caption = 'SPK Timbang Kimia  '
      Category = 0
      Hint = 'SPK Timbang Kimia  '
      Visible = ivAlways
      ...
      Glyph.Data = {
        ...
        FCFFFCFCFCFFFCFCFCFFFCFCFCFFFCFCFCFFFDFDFDFFFDFDFDFFFDFDFDFFFDFD
        FDFFFDFDFDFFFDFDFDFFFCFCFCFFFCFCFCFFFDFDFDFF}
      OnClick = BPrintTimbangKimiaClick
    end
  end
  object QSpkFormula: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      
        'select a.*,b.wh_name from warehouse.t_spk_formula a INNER JOIN t' +
        '_wh b on a.wh_code=b.wh_code')
    Left = 512
    Top = 64
  end
  object DsSpkFormula: TDataSource
    DataSet = MemSpkFormula
    Left = 512
    Top = 16
  end
  object MemSpkFormula: TMemTableEh
    Params = <>
    DataDriver = DsdSPKFormula
    Left = 448
    Top = 8
  end
  object DsdSPKFormula: TDataSetDriverEh
    ProviderDataSet = QSpkFormula
    Left = 448
    Top = 48
  end
  object QSpkFormuladet: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      
        'select A.*,C.item_name, D.supplier_name,e.wh_name,f.wh_name wh_t' +
        'ransite from warehouse.t_spk_formula_det A left join warehouse.t' +
        '_item_stock B on A.item_stock_code=B.item_stock_code'
      
        'left join t_item C on B.item_code=C.item_code left join t_suppli' +
        'er D on B.supplier_code=D.supplier_code INNER JOIN t_wh e on a.w' +
        'h_code=e.wh_code INNER JOIN t_wh f on a.wh_code2=f.wh_code'
      'order by item_stock_code Asc')
    MasterSource = DsSpkFormula
    MasterFields = 'spk_no'
    DetailFields = 'spk_no'
    Left = 608
    Top = 24
  ...
  object DsSpkFormuladet: TDataSource
    DataSet = QSpkFormuladet
    Left = 672
    Top = 8
  end
  ...
  object Rpt: TfrxReport
    ...
    ReportOptions.CreateDate = 44151.614511342600000000
    ReportOptions.LastChange = 45441.598453182900000000
    ...
    object Page2: TfrxReportPage
      ...
      object MasterData2: TfrxMasterData
        ...
        object Memo35: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Perkiraan Tgl Selesai')
          ParentFont = False
        end
        object Memo36: TfrxMemoView
          AllowVectorExport = True
          Left = 587.716535433071000000
      ...
      object PageHeader2: TfrxPageHeader
        ...
        object Memo45: TfrxMemoView
          AllowVectorExport = True
          Left = 102.047244090000000000
          Top = 30.704700000000000000
          Width = 378.519790000000000000
        ...
        object Memo46: TfrxMemoView
          ...
          Top = 30.736220470000000000
          Width = 297.826771653543000000
          Height = 23.055118110000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
        ...
        object Memo47: TfrxMemoView
          AllowVectorExport = True
          Left = 187.333333330000000000
          Top = 35.204700000000000000
          Width = 18.488250010000000000
        ...
        object Picture2: TfrxPictureView
          AllowVectorExport = True
          Left = 29.500000000000000000
          Top = 2.704700000000000000
        ...
        object Memo49: TfrxMemoView
          AllowVectorExport = True
          Left = 524.752010000000000000
          Top = 35.102350000000000000
          Width = 13.988250000000000000
          Height = 14.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
      ...
      object PageFooter2: TfrxPageFooter
        ...
        object Line3: TfrxLineView
          AllowVectorExport = True
          Left = 234.440952200000000000
          Top = 2.015770000000000000
          Height = 86.500000000000000000
          Color = clBlack
          Frame.Typ = [ftLeft]
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<DbRptSPK."index">,DetailData2,3)]')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object QRptSPK: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select A.*,C.item_name,e.amount_weight as jmlh, f.group_name, D.' +
        'supplier_name, E.* '
      'from warehouse.t_spk_formula_det A '
      ...
      'inner join warehouse.t_spk_formula e on a.spk_no=e.spk_no'
      'INNER JOIN t_item_group f on c.group_id=f.group_id'
      'order by a.id Asc')
    Left = 470
    Top = 234
  end
