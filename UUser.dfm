object FUser: TFUser
  ...
  object QUser: TUniQuery
    ...
    object QUserpassword: TMemoField
      FieldName = 'password'
      Required = True
      BlobType = ftMemo
    end
    object QUserdept: TStringField
      FieldName = 'dept'
      ReadOnly = True
      Size = 50
    end
    object QUserposition: TStringField
      FieldName = 'position'
      ReadOnly = True
      Size = 50
    end
    object QUserdept_code: TSmallintField
      FieldName = 'dept_code'
      ReadOnly = True
      Required = True
    end
    object QUserposition_code: TIntegerField
      FieldName = 'position_code'
      ReadOnly = True
      Required = True
    end
