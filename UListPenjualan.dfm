object FDataListPenjualan: TFDataListPenjualan
  Left = 0
  Top = 0
  Caption = 'Penjualan'
  ClientHeight = 518
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarLargeButton3: TdxBarLargeButton
      Caption = '   Print    Nota Tagihan'
      Category = 0
      Hint = '   Print    Nota Tagihan'
      Visible = ivAlways
    ...
    object dxBarLargeButton9: TdxBarLargeButton
      ...
      LargeGlyph.Data = {
        ...
        
        E3C6738FE873360000000049454E44AE426082}
  ...
  object QCetak: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select a."trans_no", "no_inv_tax", "trans_date", a."code_cust", ' +
        'a."name_cust",  d."address",COALESCE(e.no_npwp,'#39#39') no_npwp, b."c' +
        'ode_item", b."name_item",  b."amount", b."code_unit", b."name_un' +
        'it", a."no_reference", "unit_price",  b."sub_total", b."ppn_acco' +
        'unt", "ppn_percent", b."ppn_value", b."pph_account",  b."pph_nam' +
        'e", b."pph_percent", b."pph_value", b."tot_piece_value",  b."tot' +
        '_piece_percent", b."grand_tot",   case when "piece_first" is nul' +
        'l then 0 else "piece_first" end "piece_first",  case when "piece' +
        '_second" is null then 0 else "piece_second" end "piece_second", ' +
        ' case when "piece_third" is null then 0 else "piece_third" end "' +
        'piece_third",  case when "piece_fourth" is null then 0 else "pie' +
        'ce_fourth" end "piece_fourth", e.customer_name_pkp  from "public' +
        '"."t_selling" a  LEFT JOIN "public"."t_selling_det" b ON a.trans' +
        '_no=b.trans_no  LEFT JOIN "public"."t_selling_piece" c ON b.tran' +
        's_no=c.trans_no and b.code_item=c.code_item  LEFT JOIN (SELECT "' +
        'customer_code", "address" from "public"."t_customer_address" whe' +
        're "code_details"='#39'001'#39') d on a.code_cust=d.customer_code  LEFT ' +
        'JOIN t_customer e on e.customer_code=a.code_cust  where a.delete' +
        'd_at is null and  a.trans_no='#39'FP/001/15/X/2025/HLJ/JKT'#39'  order b' +
        'y b.created_at Desc')
    Left = 468
    Top = 248
    ...
    object QCetakno_npwp: TMemoField
      FieldName = 'no_npwp'
      ReadOnly = True
      BlobType = ftMemo
    end
    object QCetakcode_item: TStringField
      FieldName = 'code_item'
      ReadOnly = True
      Size = 100
    end
    ...
    object QCetakcode_unit: TStringField
      FieldName = 'code_unit'
      ReadOnly = True
      Size = 100
    end
    object QCetakname_unit: TStringField
      FieldName = 'name_unit'
      ReadOnly = True
      Size = 255
    end
    object QCetakno_reference: TStringField
      FieldName = 'no_reference'
      Size = 255
    end
    object QCetakunit_price: TFloatField
      FieldName = 'unit_price'
      ReadOnly = True
    end
    object QCetaksub_total: TFloatField
      FieldName = 'sub_total'
      ReadOnly = True
    end
    object QCetakppn_account: TStringField
      FieldName = 'ppn_account'
      ReadOnly = True
      Size = 255
    end
    object QCetakppn_percent: TFloatField
      FieldName = 'ppn_percent'
      ReadOnly = True
    end
    object QCetakppn_value: TFloatField
      FieldName = 'ppn_value'
      ReadOnly = True
    end
    object QCetakpph_account: TStringField
      FieldName = 'pph_account'
      ReadOnly = True
      Size = 100
    end
    object QCetakpph_name: TStringField
      FieldName = 'pph_name'
      ReadOnly = True
      Size = 255
    end
    object QCetakpph_percent: TFloatField
      FieldName = 'pph_percent'
      ReadOnly = True
    end
    object QCetakpph_value: TFloatField
      FieldName = 'pph_value'
      ReadOnly = True
    end
    object QCetaktot_piece_value: TFloatField
      FieldName = 'tot_piece_value'
      ReadOnly = True
    end
    object QCetaktot_piece_percent: TFloatField
      FieldName = 'tot_piece_percent'
      ReadOnly = True
    end
    object QCetakgrand_tot: TFloatField
      FieldName = 'grand_tot'
      ReadOnly = True
    end
    object QCetakpiece_first: TFloatField
      FieldName = 'piece_first'
      ReadOnly = True
    end
    object QCetakpiece_second: TFloatField
      FieldName = 'piece_second'
      ReadOnly = True
    end
    object QCetakpiece_third: TFloatField
      FieldName = 'piece_third'
      ReadOnly = True
    end
    object QCetakpiece_fourth: TFloatField
      FieldName = 'piece_fourth'
      ReadOnly = True
    end
    object QCetakcustomer_name_pkp: TStringField
      FieldName = 'customer_name_pkp'
      ReadOnly = True
      Size = 255
    end
  ...
  object Report: TfrxReport
    ...
    ReportOptions.LastChange = 45980.456716770830000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo2: TfrxMemoView
          ...
          Left = -0.219298250000000000
          Top = 36.345856670000000000
        ...
        object Line4: TfrxLineView
          AllowVectorExport = True
          Left = 302.850650000000000000
          Top = 166.228510000000000000
          Height = 662.173228350000000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
        end
        ...
        object Line6: TfrxLineView
          AllowVectorExport = True
          Left = 483.165740000000000000
          Top = 187.228510000000000000
          Height = 481.511811020000000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
        end
        object Line7: TfrxLineView
          AllowVectorExport = True
          Left = 567.535870000000000000
          Top = 187.086614170000000000
          Height = 481.511811020000000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
        ...
        object Line23: TfrxLineView
          AllowVectorExport = True
          Left = 0.052631580000000000
          Top = -0.055544740000000000
        ...
        object MemPO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 551.055118110236200000
          Top = 126.486965380000000000
          Width = 187.982057720000000000
          Height = 22.677180000000000000
          DataSet = frxDBDPenjualan
          DataSetName = 'frxDBDPenjualan'
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object terbilang: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Lima Ratus Sembilan Puluh Ribu Enam Ratus Empat Puluh Enam Rupia' +
              'h')
          ParentFont = False
        end
        object Memo19: TfrxMemoView
          AllowVectorExport = True
          Left = 310.630180000000000000
        ...
        object Line10: TfrxLineView
          AllowVectorExport = True
          Left = 304.016080000000000000
          Top = 26.456692910000000000
          Width = 452.787401574803000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
        end
        ...
        object MemPPN: TfrxMemoView
          Anchors = [fraLeft]
          AllowVectorExport = True
          Left = 642.546383330000000000
          Top = 56.015460000000000000
          Width = 108.359616670000000000
          Height = 18.897650000000000000
          DisplayFormat.FormatStr = '%2.n'
          DisplayFormat.Kind = fkNumeric
          Font.Charset = DEFAULT_CHARSET
        ...
        object MemGrandTot: TfrxMemoView
          Anchors = [fraLeft]
          AllowVectorExport = True
          Left = 642.879716670000000000
          Top = 3.779527560000000000
          Width = 108.026283330000000000
          Height = 18.897650000000000000
          DisplayFormat.FormatStr = '%2.n'
          DisplayFormat.Kind = fkNumeric
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo31: TfrxMemoView
          AllowVectorExport = True
          Left = 312.666666670000000000
          Top = 110.264275560000000000
          Width = 316.149660000000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object Memo33: TfrxMemoView
          Anchors = [fraLeft]
          AllowVectorExport = True
          Left = 641.471758900000000000
          Top = 109.571015560000000000
          Width = 111.026283330000000000
          Height = 18.897650000000000000
          DisplayFormat.FormatStr = '%2.n'
          DisplayFormat.Kind = fkNumeric
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo34: TfrxMemoView
          AllowVectorExport = True
          Left = 311.666666670000000000
          Top = 136.687434590000000000
        ...
        object Line15: TfrxLineView
          AllowVectorExport = True
          Left = 304.052566670000000000
          Top = 132.348793330000000000
          Width = 452.787401574803000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
        ...
        object Memo35: TfrxMemoView
          Anchors = [fraLeft]
          AllowVectorExport = True
          Left = 642.027314450000000000
          Top = 136.818897640000000000
          Width = 109.915172220000000000
          Height = 18.897650000000000000
          DisplayFormat.FormatStr = '%2.n'
          DisplayFormat.Kind = fkNumeric
          Font.Charset = DEFAULT_CHARSET
        ...
        object Line16: TfrxLineView
          AllowVectorExport = True
          Left = 303.888888890000000000
          Top = 159.126571110000000000
          Width = 452.787401574803000000
          Color = clBlack
          Frame.Typ = []
          Diagonal = True
        ...
        object signature_name: TfrxMemoView
          AllowVectorExport = True
          Left = 518.672233330000000000
          Top = 243.653680000000000000
        ...
        object Memo37: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 517.083333330000000000
          Top = 167.527983330000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Tangerang, [frxDBDPenjualan."trans_date"]')
          ParentFont = False
        end
        object Memo38: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 7.083333330000000000
          Top = 240.805761100000000000
          Width = 84.780303340000000000
          Height = 52.647637800000000000
          DataSet = frxDBDPenjualan
          DataSetName = 'frxDBDPenjualan'
          DisplayFormat.FormatStr = 'dd mmmm yyyy'
          DisplayFormat.Kind = fkDateTime
        ...
        object MemSubTotal: TfrxMemoView
          Anchors = [fraLeft]
          AllowVectorExport = True
          Left = 643.324161110000000000
          Top = 83.149606300000000000
          Width = 107.581838890000000000
          Height = 18.897650000000000000
          DisplayFormat.FormatStr = '%2.n'
          DisplayFormat.Kind = fkNumeric
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo49: TfrxMemoView
          Anchors = [fraLeft]
          AllowVectorExport = True
          Left = 643.362204720000000000
          Top = 29.944650000000000000
          Width = 107.581838890000000000
          Height = 18.897650000000000000
          DisplayFormat.FormatStr = '%2.n'
          DisplayFormat.Kind = fkNumeric
  ...
  object QCetakSJ: TUniQuery
    ...
    object QCetakSJname_cust: TStringField
      FieldName = 'name_cust'
      Size = 255
    end
    ...
    object QCetakSJcode_item: TStringField
      FieldName = 'code_item'
      ReadOnly = True
      Size = 100
    end
    object QCetakSJname_item: TStringField
      FieldName = 'name_item'
      ReadOnly = True
      Size = 255
    end
    object QCetakSJamount: TFloatField
      FieldName = 'amount'
      ReadOnly = True
    end
    object QCetakSJcode_unit: TStringField
      FieldName = 'code_unit'
      ReadOnly = True
      Size = 100
    end
    ...
    object QCetakSJket: TStringField
      FieldName = 'ket'
      ReadOnly = True
      Size = 100
    end
    ...
    object QCetakSJtare_weight: TFloatField
  ...
  object frxReport1: TfrxReport
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo8: TfrxMemoView
          AllowVectorExport = True
          Left = 46.559060000000000000
          Top = 131.889920000000000000
          Width = 95.606370000000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
        ...
        object Memo10: TfrxMemoView
          AllowVectorExport = True
          Left = 265.330860000000000000
          Top = 131.779527560000000000
          Width = 486.228510000000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBDCetakSJamount: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 47.559060000000000000
          Width = 93.826840000000000000
          Height = 18.897650000000000000
          DataField = 'amount'
          DataSet = frxDBDCetakSJ
          DataSetName = 'frxDBDCetakSJ'
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDCetakSJ."amount"]')
          ParentFont = False
        end
        object frxDBDCetakSJcode_item: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 147.724490000000000000
        ...
        object Memo15: TfrxMemoView
          ...
          Top = -1.330860000000000000
          Width = 43.826840000000000000
          Height = 18.897650000000000000
          DataSet = frxDBDCetakSJ
          DataSetName = 'frxDBDCetakSJ'
          DisplayFormat.FormatStr = '%0.0n'
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo29: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDCetakSJ."address2"]')
          ParentFont = False
        end
        object Memo30: TfrxMemoView
          AllowVectorExport = True
          Left = 4.000000000000000000
          Top = 9.299010000000000000
  ...
  object ReportJurnal: TfrxReport
    ...
    ReportOptions.LastChange = 45946.450206284720000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
