object Fdaftar_deposito: TFdaftar_deposito
  Left = 0
  Top = 0
  ...
  object DBGrid_Daf_Deposito: TDBGridEh
    Left = 0
    Top = 225
    Width = 834
    Height = 208
    Align = alClient
    DataSource = DSdaftar_deposito
    DynProps = <>
  ...
  object PnFilter: TPanel
    ...
    object dptgldep1: TDateTimePicker
      Left = 164
      Top = 65
      Width = 117
      Height = 21
      Date = 45671.000000000000000000
      Time = 0.609364374999131500
      ImeName = 'US'
      TabOrder = 0
    end
    object dptgldep2: TDateTimePicker
      Left = 314
      Top = 65
      Width = 117
      Height = 21
  ...
  object Qdaftar_deposito: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      
        'select a.*,b.bank_name from t_deposito a,t_bank b where a.bank_n' +
        'orek=b.rekening_no')
    Left = 504
    Top = 56
  end
  object DSdaftar_deposito: TDataSource
    DataSet = Qdaftar_deposito
    Left = 560
    Top = 72
  end
end
