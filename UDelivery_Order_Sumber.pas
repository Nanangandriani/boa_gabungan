         ...
         begin
           ...
           begin
             ...
             begin
                  ...
                  FNewDeliveryOrder.MemDataMuatan['kd_barang']:=MemDetail['kd_barang'];
                  FNewDeliveryOrder.MemDataMuatan['nm_barang']:=MemDetail['nm_barang'];
                  FNewDeliveryOrder.MemDataMuatan['jumlah']:=MemDetail['jumlah'];
                  FNewDeliveryOrder.MemDataMuatan['satuan']:=MemDetail['satuan'];
