object FlistBarang: TFlistBarang
  ...
  object QMaterial: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select A.*, B.nama_perkiraan -- no_urut,no_material,kd_material,' +
        'nm_material,Category,satuan,jenis'
      
        'from t_material a left join t_daftar_perkiraan b on a.kd_akun=b.' +
        'kode'
      'order by a.jenis,a.category,a.no_material Asc')
    Left = 44
    Top = 240
  end
  ...
  object dxBarManager1: TdxBarManager
    ...
    object DxbEdit1: TdxBarLargeButton
      Caption = 'Update'
      Category = 0
      Hint = 'Update'
      Visible = ivNever
