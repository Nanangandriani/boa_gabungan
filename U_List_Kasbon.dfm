object FKasbon: TFKasbon
  ...
  OnShow = FormShow
  TextHeight = 15
  object DBGridKasbon: TDBGridEh
    Left = 0
    Top = 127
    Width = 754
    Height = 315
    Align = alClient
    DataSource = DS_KasBon
    DrawMemoText = True
    DynProps = <>
    ...
    Columns = <
      ...
      item
        ...
        Footers = <>
        Title.Alignment = taCenter
        Title.Caption = 'Diberikan Kepada'
        Width = 200
      end
      item
        CellButtons = <>
  ...
  object QKasBon: TUniQuery
    Connection = dm.Koneksi
    SQL.Strings = (
      'select * from t_kasbon')
    Left = 512
    Top = 200
    object QKasBonid: TLargeintField
      FieldName = 'id'
    end
    object QKasBonbon_no: TStringField
      FieldName = 'bon_no'
      Size = 100
    end
    object QKasBongiven_to: TStringField
      FieldName = 'given_to'
      Size = 200
    end
    object QKasBonremark: TMemoField
      FieldName = 'remark'
      BlobType = ftMemo
    end
    object QKasBonamount: TFloatField
      FieldName = 'amount'
    end
    object QKasBonbig_cash: TFloatField
      FieldName = 'big_cash'
    end
    object QKasBonpetty_cash: TFloatField
      FieldName = 'petty_cash'
    end
    object QKasBonorder_no: TIntegerField
      FieldName = 'order_no'
    end
    object QKasBontrans_day: TSmallintField
      FieldName = 'trans_day'
    end
    object QKasBontrans_month: TSmallintField
      FieldName = 'trans_month'
    end
    object QKasBontrans_year: TSmallintField
      FieldName = 'trans_year'
    end
    object QKasBoncreated_at: TDateTimeField
      FieldName = 'created_at'
    end
    object QKasBoncreated_by: TStringField
      FieldName = 'created_by'
      Size = 50
    end
    object QKasBonupdated_at: TDateTimeField
      FieldName = 'updated_at'
    end
    object QKasBonupdated_by: TStringField
      FieldName = 'updated_by'
      Size = 50
    end
    object QKasBondeleted_at: TDateTimeField
      FieldName = 'deleted_at'
    end
    object QKasBondeleted_by: TStringField
      FieldName = 'deleted_by'
      Size = 50
    end
    object QKasBontrans_date: TDateField
      FieldName = 'trans_date'
    end
  end
  object DS_KasBon: TDataSource
    DataSet = QKasBon
    Left = 616
    Top = 200
  end
