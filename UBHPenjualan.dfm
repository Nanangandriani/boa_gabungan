object FBHPenjualan: TFBHPenjualan
  ...
  object QCetak: TUniQuery
    ...
    SQL.Strings = (
        ...
        'SELECT trans_no,no_inv_tax,trans_date,code_cust,name_cust from g' +
        'et_selling(FALSE) '
      'WHERE trans_date BETWEEN '#39'2025-10-06'#39' AND '#39'2025-10-06'#39
