...
type
  TFUser = class(TForm)
    ...
    DsUser: TDataSource;
    MemUser: TMemTableEh;
    QUsercode: TStringField;
    QUseruser_name: TStringField;
    QUserfull_name: TStringField;
    QUserpassword: TMemoField;
    QUserdept: TStringField;
    QUserposition: TStringField;
    QUserdept_code: TSmallintField;
    QUserposition_code: TIntegerField;
...
begin
   ...
   begin
       close;
       sql.Clear;
       sql.Text:=' select a.code,a.user_name,a.full_name,a.password,b.dept_code,b.dept,c.position_code,c.position from t_user a inner join t_dept b on a.dept_code=b.dept_code  '+
