object FBonPermt_Barang: TFBonPermt_Barang
  ...
  object QPermt_Material: TUniQuery
    ...
    SQL.Strings = (
        ...
        'ate,'#39'dd'#39') tgl from t_item_request order by created_at Desc')
    Active = True
    Left = 384
  end
  ...
  object Rpt: TfrxReport
    ...
    ReportOptions.CreateDate = 45148.688615729170000000
    ReportOptions.LastChange = 45148.688615729170000000
