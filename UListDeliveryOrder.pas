...
begin
  ...
  begin
    ...
    edPersenPPH.Value:=Dm.Qtemp.FieldByName('percent_pph').Value;
    edKodeAkunPPH.Text:=Dm.Qtemp.FieldByName('code_pph').AsString;
    edNamaAkunPPH.Text:=Dm.Qtemp.FieldByName('name_pph').AsString;
    edPersenPPN.Value:=Dm.Qtemp.FieldByName('percent_ppn').Value;
    edKodeAkunPPN.Text:=Dm.Qtemp.FieldByName('code_ppn').AsString;
    edNamaAkunPPN.Text:=Dm.Qtemp.FieldByName('name_ppn').AsString;
  ...
  //Muatan
   ...
   begin
    ...
    begin
     ...
     MemDataMuatan['ket_barang']:=Dm.Qtemp1.fieldbyname('item_desc').value;
     MemDataMuatan['ket_muatan']:=Dm.Qtemp1.fieldbyname('desc_load').value;
