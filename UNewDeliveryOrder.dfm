  ...
  object RzPageControl1: TRzPageControl
    ...
    object TabDataMuatan: TRzTabSheet
      ...
      object Panel5: TPanel
        ...
        object btMasterLokasiMuat: TSpeedButton
          Left = 626
          Top = 104
          Width = 23
          Height = 22
          Caption = '+'
          OnClick = btMasterLokasiMuatClick
        end
        object btMasterLokasiBongkar: TSpeedButton
          Left = 626
          Top = 132
          Width = 23
          Height = 22
          Caption = '+'
          OnClick = btMasterLokasiBongkarClick
        end
        ...
        object edNamaJenisMuatan: TRzButtonEdit
          ...
          Text = ''
          TabOrder = 2
          OnChange = edNamaJenisMuatanChange
          AllowKeyEdit = False
          AltBtnNumGlyphs = 1
          ButtonNumGlyphs = 1
        ...
        object edLokasiMuat: TRzButtonEdit
          Left = 132
          Top = 104
          Width = 493
          Height = 23
          ...
          AltBtnNumGlyphs = 1
          ButtonNumGlyphs = 1
          OnButtonClick = edLokasiMuatButtonClick
        end
        object edLokasiBongkar: TRzButtonEdit
          Left = 132
          Top = 132
          Width = 493
          Height = 23
