object FTransfer_Barang: TFTransfer_Barang
  ...
  object QTransfer: TUniQuery
    ...
    SQL.Strings = (
        ...
        'c.wh_name nm_to from warehouse.t_item_transfer a INNER JOIN t_wh' +
        ' b on a.wh_code_from=b.code INNER JOIN t_wh c on a.wh_code_to=c.' +
        'code  order by trans_no desc')
    Active = True
    Left = 448
    Top = 24
  end
  ...
  object Qdetail: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select A.*,b.item_name,B.order_no from warehouse.t_item_transfer' +
        '_det a inner join warehouse.t_item_stock b on A.item_stock_code=' +
        'b.item_stock_code')
