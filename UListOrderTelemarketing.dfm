object FListOrderTelemarketing: TFListOrderTelemarketing
  ...
  object MemMasterData: TMemTableEh
    ...
    Left = 488
    Top = 256
    object MemMasterDataticket_number: TStringField
      FieldName = 'ticket_number'
      Size = 50
    end
    object MemMasterDataorder_date: TDateField
      FieldName = 'order_date'
    end
    object MemMasterDataoutlet_name: TStringField
      FieldName = 'outlet_name'
      Size = 50
    end
    object MemMasterDatastatus_name: TStringField
      FieldName = 'status_name'
      Size = 255
    end
    ...
    object MemTableData: TMemTableDataEh
      object DataStruct: TMTDataStructEh
        ...
        object order_date: TMTDateTimeDataFieldEh
          FieldName = 'order_date'
          DateTimeDataType = fdtDateEh
          DisplayWidth = 255
        end
        object outlet_name: TMTStringDataFieldEh
          FieldName = 'outlet_name'
          StringDataType = fdtStringEh
          DisplayWidth = 50
          Size = 50
