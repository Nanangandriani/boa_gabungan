object FPermintaan_Barang2: TFPermintaan_Barang2
  Left = 0
  Top = 0
  Caption = 'Form Transfer Barang Untuk Etiket & Amplop'
  ClientHeight = 443
  ClientWidth = 778
  Color = clBtnFace
  ...
  object DBGridPermt_Material: TDBGridEh
    ...
    DataGrouping.GroupLevels = <
      item
        ColumnName = 'Column_7_trans_year'
      end
      item
